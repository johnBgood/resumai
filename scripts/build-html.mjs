  ...
  <main class="main">
    ...
    <section>
      ...
      <div class="job">
        ...
        <ul>
          <li>Managed a team of <strong>5 engineers</strong>; hired <strong>2 of them end-to-end</strong></li>
          <li>Led delivery of <strong>Structured Interviews</strong> — a major product addition enabling science-based interview frameworks</li>
          <li>Resolved engineering-wide issues (developer experience, cross-team processes) and created a <strong>system design interview process</strong></li>
        </ul>
      </div>
      ...
      <div class="job">
        ...
        <ul>
          <li>Designed scalable microservices (Java, MongoDB, Prometheus, Grafana) handling <strong>5B metrics/day</strong>; reduced bandwidth by <strong>50%</strong> and increased monitoring capacity <strong>×10</strong></li>
          <li>Designed and implemented <strong>RBAC system</strong>; trained team on new concepts</li>
        </ul>
      </div>
    </section>
